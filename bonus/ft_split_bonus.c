...
/*   Updated: 2024/04/25 08:26:49 by alouriga         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "checker_bonus.h"

static	int	nb_word( char *st, char c)
{
	int	i;
	int	t;
	int	j;
...
static char	*dimensional(t_slotlist *slots, char *s, int d, int f)
{
	int		i;
	char	*p;
...
static char	**allocation(t_slotlist *slots, char *s, size_t i, char c)
{
	int		v;
	size_t	j;
	char	**p;
